...
static ZKButton* mChildLockButtonPtr;
static ZKButton* mUVButtonPtr;
static ZKButton* mModeButtonPtr;
...
static ZKTextView* mHumidityTextPtr;
static ZKTextView* mTextview3Ptr;
static ZKTextView* mTextview4Ptr;
static ZKTextView* mCurTempTextPtr;
static ZKTextView* mairlevelTextPtr;
static ZKTextView* mTextview2Ptr;
static ZKButton* mPM25ButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_MAIN_ChildLockButton, onButtonClick_ChildLockButton,
    ID_MAIN_UVButton, onButtonClick_UVButton,
    ID_MAIN_ModeButton, onButtonClick_ModeButton,
    ID_MAIN_Button4, onButtonClick_Button4,
    ID_MAIN_PM25Button, onButtonClick_PM25Button,
...
void mainActivity::onCreate() {
    ...
    mChildLockButtonPtr = (ZKButton*)findControlByID(ID_MAIN_ChildLockButton);
    mUVButtonPtr = (ZKButton*)findControlByID(ID_MAIN_UVButton);
    mModeButtonPtr = (ZKButton*)findControlByID(ID_MAIN_ModeButton);
    ...
    mHumidityTextPtr = (ZKTextView*)findControlByID(ID_MAIN_HumidityText);
    mTextview3Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview3);
    mTextview4Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview4);
    mCurTempTextPtr = (ZKTextView*)findControlByID(ID_MAIN_CurTempText);
    mairlevelTextPtr = (ZKTextView*)findControlByID(ID_MAIN_airlevelText);
    mTextview2Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview2);
    mPM25ButtonPtr = (ZKButton*)findControlByID(ID_MAIN_PM25Button);
